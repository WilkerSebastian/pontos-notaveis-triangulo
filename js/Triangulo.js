...
var Triangulo = /** @class */ (function () {
    ...
    Triangulo.prototype.render = function (ctx) {
        ...
        var bc = this.getLine(this.B, this.C);
        var ca = this.getLine(this.C, this.A);
        var G = scale(this.baricentro().x, this.baricentro().y);
        var I = scale(this.incentro().x, this.incentro().y);
        var H = scale(this.ortocentro().x, this.ortocentro().y);
        var N = scale(this.circuncentro().N.x, this.circuncentro().N.y);
        var P = scale(this.circuncentro().P.x, this.circuncentro().P.y);
        var Q = scale(this.circuncentro().Q.x, this.circuncentro().Q.y);
        var R = scale(this.circuncentro().R.x, this.circuncentro().R.y);
